...
class ModalClientModal:
    ...
    def __init__(self, grpclib_stub: modal_proto.api_grpc.ModalClientStub, client: "modal.client._Client", server_url: str) -> None:
        ...
        self.AppCountLogs = modal._grpc_client.UnaryUnaryWrapper(grpclib_stub.AppCountLogs, client, server_url)
        ...
        self.AppFetchLogs = modal._grpc_client.UnaryUnaryWrapper(grpclib_stub.AppFetchLogs, client, server_url)
        ...
        self.AppGetLifecycle = modal._grpc_client.UnaryUnaryWrapper(grpclib_stub.AppGetLifecycle, client, server_url)
        ...
        self.AppRollover = modal._grpc_client.UnaryUnaryWrapper(grpclib_stub.AppRollover, client, server_url)
        ...
        self.EnvironmentRoleSet = modal._grpc_client.UnaryUnaryWrapper(grpclib_stub.EnvironmentRoleSet, client, server_url)
        self.EnvironmentSetManaged = modal._grpc_client.UnaryUnaryWrapper(grpclib_stub.EnvironmentSetManaged, client, server_url)
        ...
        self.SandboxGetTaskIdV2 = modal._grpc_client.UnaryUnaryWrapper(grpclib_stub.SandboxGetTaskIdV2, client, server_url)
        self.SandboxGetTunnels = modal._grpc_client.UnaryUnaryWrapper(grpclib_stub.SandboxGetTunnels, client, server_url)
        self.SandboxGetTunnelsV2 = modal._grpc_client.UnaryUnaryWrapper(grpclib_stub.SandboxGetTunnelsV2, client, server_url)
        ...
        self.SandboxTerminateV2 = modal._grpc_client.UnaryUnaryWrapper(grpclib_stub.SandboxTerminateV2, client, server_url)
        self.SandboxWait = modal._grpc_client.UnaryUnaryWrapper(grpclib_stub.SandboxWait, client, server_url)
        self.SandboxWaitUntilReady = modal._grpc_client.UnaryUnaryWrapper(grpclib_stub.SandboxWaitUntilReady, client, server_url)
        self.SandboxWaitV2 = modal._grpc_client.UnaryUnaryWrapper(grpclib_stub.SandboxWaitV2, client, server_url)
        ...
        self.ServiceUserList = modal._grpc_client.UnaryUnaryWrapper(grpclib_stub.ServiceUserList, client, server_url)
        ...
        self.TaskGetInfo = modal._grpc_client.UnaryUnaryWrapper(grpclib_stub.TaskGetInfo, client, server_url)
        ...
        self.TemplateList = modal._grpc_client.UnaryUnaryWrapper(grpclib_stub.TemplateList, client, server_url)
        ...
        self.WorkspaceMembersList = modal._grpc_client.UnaryUnaryWrapper(grpclib_stub.WorkspaceMembersList, client, server_url)
